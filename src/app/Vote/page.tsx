...
import { motion, useMotionValue, useTransform } from "framer-motion"; // ✅ correct
...
export default function Vote() {
  ...
  const saveVotes = (finalVotes: { [key: string]: boolean }) => {
    ...
    if (pollData) {
      ...
      const voterId =
        voterName || `Voter ${Math.random().toString(36).substring(7)}`;
    ...
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center p-4">
        ...
        >
          ...
          <p className="text-gray-600 mb-8">Your votes have been recorded</p>
              ...
              <div className="bg-gradient-to-br from-white to-gray-50 border-4 border-gray-200 rounded-3xl shadow-2xl h-full flex items-center justify-center p-8">
                <div className="text-center">
                  ...
                  <h2 className="text-3xl font-bold text-gray-900">
                    {currentOption.replace(/[\p{Emoji}]/gu, "").trim() ||
                      currentOption}
                  </h2>
                </div>
              </div>
